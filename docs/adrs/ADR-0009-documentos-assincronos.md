...
- **Gemini com consentimento.** Upload e reprocessamento exigem consentimento vigente do usuário ao aviso versionado, e o Worker confere de novo antes do OCR. Não há fallback P7 para OCR no M2.
